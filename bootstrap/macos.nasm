...
section .data
    ...
    global_string_178: db `SYS_execve`, 0
    global_string_179: db `SYS_read`, 0
    global_string_180: db `SYS_write`, 0
    global_string_181: db `SYS_exit`, 0
    global_string_182: db `SYS_open`, 0
    global_string_183: db `SYS_lseek`, 0
    global_string_184: db `SYS_openat`, 0
    global_string_185: db `SYS_close`, 0
    global_string_186: db `SYS_fork`, 0
    global_string_187: db `SYS_wait4`, 0
    global_string_188: db `SYS_mmap`, 0
    global_string_189: db `SEEK_SET`, 0
    global_string_190: db `SEEK_CUR`, 0
    global_string_191: db `SEEK_END`, 0
    global_string_192: db `O_RDONLY`, 0
    global_string_193: db `O_WRONLY`, 0
    global_string_194: db `O_RDWR`, 0
    global_string_195: db `O_CREAT`, 0
    global_string_196: db `O_EXCL`, 0
    global_string_197: db `O_TRUNC`, 0
    global_string_198: db `AT_FDCWD`, 0
    global_string_199: db `PROT_READ`, 0
    global_string_200: db `PROT_WRITE`, 0
    global_string_201: db `PROT_EXEC`, 0
    global_string_202: db `PROT_NONE`, 0
    global_string_203: db `MAP_SHARED`, 0
    global_string_204: db `MAP_PRIVATE`, 0
    global_string_205: db `MAP_ANONYMOUS`, 0
    global_string_206: db `MAP_FIXED`, 0
    global_string_207: db `MAP_FAILED`, 0
    global_string_208: db `OS_IS_MACOS`, 0
    global_string_209: db `OS_IS_LINUX`, 0
    global_string_210: db `print`, 0
    global_string_211: db `val`, 0
    global_string_212: db `fork`, 0
    global_string_213: db `syscall0`, 0
    global_string_214: db `syscall1`, 0
    global_string_215: db `syscall2`, 0
    global_string_216: db `syscall3`, 0
    global_string_217: db `syscall4`, 0
    global_string_218: db `syscall5`, 0
    global_string_219: db `syscall6`, 0
    global_string_220: db `syscall7`, 0
    global_string_221: db `func_print:\n`, 0
    global_string_222: db `    mov rdi, [rsp+8]\n`, 0
    global_string_223: db `    mov r9, -3689348814741910323\n`, 0
    global_string_224: db `    sub rsp, 40\n`, 0
    global_string_225: db `    mov byte [rsp+31], 10\n`, 0
    global_string_226: db `    lea rcx, [rsp+30]\n`, 0
    global_string_227: db `    mov qword rbx, 0\n`, 0
    global_string_228: db `.L2:\n`, 0
    global_string_229: db `    mov rax, rdi\n`, 0
    global_string_230: db `    lea r8, [rsp+32]\n`, 0
    global_string_231: db `    mul r9\n`, 0
    global_string_232: db `    mov rax, rdi\n`, 0
    global_string_233: db `    sub r8, rcx\n`, 0
    global_string_234: db `    shr rdx, 3\n`, 0
    global_string_235: db `    lea rsi, [rdx+rdx*4]\n`, 0
    global_string_236: db `    add rsi, rsi\n`, 0
    global_string_237: db `    sub rax, rsi\n`, 0
    global_string_238: db `    add eax, 48\n`, 0
    global_string_239: db `    mov byte [rcx], al\n`, 0
    global_string_240: db `    mov rax, rdi\n`, 0
    global_string_241: db `    mov rdi, rdx\n`, 0
    global_string_242: db `    mov rdx, rcx\n`, 0
    global_string_243: db `    sub rcx, 1\n`, 0
    global_string_244: db `    cmp rax, 9\n`, 0
    global_string_245: db `    ja .L2\n`, 0
    global_string_246: db `    lea rax, [rsp+32]\n`, 0
    global_string_247: db `    mov edi, 1\n`, 0
    global_string_248: db `    sub rdx, rax\n`, 0
    global_string_249: db `    xor eax, eax\n`, 0
    global_string_250: db `    lea rsi, [rsp+32+rdx]\n`, 0
    global_string_251: db `    mov rdx, r8\n`, 0
    global_string_252: db `    add rsp, 40\n`, 0
    global_string_253: db `    ret\n`, 0
    global_string_254: db `rax`, 0
    global_string_255: db `rdi`, 0
    global_string_256: db `rsi`, 0
    global_string_257: db `rdx`, 0
    global_string_258: db `rcx`, 0
    global_string_259: db `r8`, 0
    global_string_260: db `r9`, 0
    global_string_261: db `r10`, 0
    global_string_262: db `r11`, 0
    global_string_263: db `r12`, 0
    global_string_264: db `func_syscall`, 0
    global_string_265: db `:\n`, 0
    global_string_266: db `    mov `, 0
    global_string_267: db `, [rsp+`, 0
    global_string_268: db `]\n`, 0
    global_string_269: db `    syscall\n`, 0
    global_string_270: db `    ret\n`, 0
    global_string_271: db `func_fork:\n`, 0
    global_string_272: db `    mov rdi, [rsp+8]\n`, 0
    global_string_273: db `    mov rax, `, 0
    global_string_274: db `\n`, 0
    global_string_275: db `    syscall\n`, 0
    global_string_276: db `    cmp rdx, 0\n`, 0
    global_string_277: db `    je .L1\n`, 0
    global_string_278: db `    mov rax, 0\n`, 0
    global_string_279: db `.L1:\n`, 0
    global_string_280: db `    ret\n`, 0
    global_string_281: db `here`, 0
    global_string_282: db `:`, 0
    global_string_283: db `:`, 0
    global_string_284: db `EOF while parsing string literal`, 0
    global_string_285: db `compiler/lexer.cup:248:29`, 0
    global_string_286: db `Unknown character in lexer_next: '`, 0
    global_string_287: db `'`, 0
    global_string_288: db `Exiting`, 0
    global_string_289: db `: Expected `, 0
    global_string_290: db ` but got `, 0
    global_string_291: db `Constant expressions can only contain integer literals/constants.`, 0
    global_string_292: db `Unsupported binary operator in constant expression.`, 0
    global_string_293: db `Unsupported constant expression.`, 0
    global_string_294: db `Identifier already exists: `, 0
    global_string_295: db `compiler/parser.cup:147:18`, 0
    global_string_296: db `Expected 'int' type for constant`, 0
    global_string_297: db `compiler/parser.cup:155:21`, 0
    global_string_298: db `Unexpected token in parse_literal: `, 0
    global_string_299: db `compiler/parser.cup:182:18`, 0
    global_string_300: db `Unknown token in parse_type: `, 0
    global_string_301: db `compiler/parser.cup:204:22`, 0
    global_string_302: db `Could not find constant: `, 0
    global_string_303: db `compiler/parser.cup:226:30`, 0
    global_string_304: db `Expected a constant expression for array size`, 0
    global_string_305: db `compiler/parser.cup:231:25`, 0
    global_string_306: db `Function call argument count mismatch: `, 0
    global_string_307: db `compiler/parser.cup:269:18`, 0
    global_string_308: db `Unknown identifier in parse_identifier: `, 0
    global_string_309: db `compiler/parser.cup:311:14`, 0
    global_string_310: db `Cannot increment non-lvalue`, 0
    global_string_311: db `compiler/parser.cup:337:21`, 0
    global_string_312: db `Cannot decrement non-lvalue`, 0
    global_string_313: db `compiler/parser.cup:351:21`, 0
    global_string_314: db `Cannot take address of non-lvalue`, 0
    global_string_315: db `compiler/parser.cup:389:21`, 0
    global_string_316: db `Cannot dereference non-pointer type`, 0
    global_string_317: db `compiler/parser.cup:396:21`, 0
    global_string_318: db `: Unexpected token found in parse_factor: `, 0
    global_string_319: db `compiler/parser.cup:403:18`, 0
    global_string_320: db `Cannot index non-pointer/array type`, 0
    global_string_321: db `compiler/parser.cup:411:25`, 0
    global_string_322: db `Cannot access member of non-struct type`, 0
    global_string_323: db `compiler/parser.cup:431:25`, 0
    global_string_324: db `Struct type: `, 0
    global_string_325: db `Field name: `, 0
    global_string_326: db `Invalid field name for struct`, 0
    global_string_327: db `compiler/parser.cup:444:25`, 0
    global_string_328: db `THEN and ELSE branches of conditional expression have different types`, 0
    global_string_329: db `compiler/parser.cup:634:21`, 0
    global_string_330: db `Identifier already defined: %s`, 0
    global_string_331: db `compiler/parser.cup:692:18`, 0
    global_string_332: db `- Variable type: `, 0
    global_string_333: db `- Value type: `, 0
    global_string_334: db `Type mismatch for variable declaration: `, 0
    global_string_335: db `compiler/parser.cup:719:22`, 0
    global_string_336: db `Expected ':' or '=' after variable declaration`, 0
    global_string_337: db `compiler/parser.cup:724:17`, 0
    global_string_338: db `------------------`, 0
    global_string_339: db ` : Variable declared`, 0
    global_string_340: db `Name: `, 0
    global_string_341: db `Type: `, 0
    global_string_342: db `Offset: `, 0
    global_string_343: db `\n------------------`, 0
    global_string_344: db `Identifier already defined: `, 0
    global_string_345: db `compiler/parser.cup:761:22`, 0
    global_string_346: db `defer is not implemented yet`, 0
    global_string_347: db `compiler/parser.cup:885:17`, 0
    global_string_348: db `Identifier already exists, enums just behave like numbered constants.`, 0
    global_string_349: db `compiler/parser.cup:934:21`, 0
    global_string_350: db `Expected a comma or a closing brace.`, 0
    global_string_351: db `compiler/parser.cup:944:21`, 0
    global_string_352: db `Expected STRUCT or UNION in parse_struct_union_declaration`, 0
    global_string_353: db `compiler/parser.cup:958:17`, 0
    global_string_354: db `You need to specify a name for the struct defined globally.`, 0
    global_string_355: db `compiler/parser.cup:967:17`, 0
    global_string_356: db `<anonymous>`, 0
    global_string_357: db `Function name already exists as an identifier`, 0
    global_string_358: db `compiler/parser.cup:1045:21`, 0
    global_string_359: db `Function already defined earlier`, 0
    global_string_360: db `compiler/parser.cup:1048:21`, 0
    global_string_361: db `Found a circular import dependency in: `, 0
    global_string_362: db `: Exiting.`, 0
    global_string_363: db `unexpected token in parse_program: `, 0
    global_string_364: db `compiler/parser.cup:1132:22`, 0
    global_string_365: db `-`, 0
    global_string_366: db `    mov rax, `, 0
    global_string_367: db `\n`, 0
    global_string_368: db `    syscall\n`, 0
    global_string_369: db `al`, 0
    global_string_370: db `ax`, 0
    global_string_371: db `eax`, 0
    global_string_372: db `rax`, 0
    global_string_373: db `Unsupported type size`, 0
    global_string_374: db `compiler/codegen.cup:52:10`, 0
    global_string_375: db `byte`, 0
    global_string_376: db `word`, 0
    global_string_377: db `dword`, 0
    global_string_378: db `qword`, 0
    global_string_379: db `Unsupported type size`, 0
    global_string_380: db `compiler/codegen.cup:61:10`, 0
    global_string_381: db `    mov rax, rbp\n`, 0
    global_string_382: db `    sub rax, `, 0
    global_string_383: db `\n`, 0
    global_string_384: db `    mov rax, global_vars\n`, 0
    global_string_385: db `    add rax, `, 0
    global_string_386: db `\n`, 0
    global_string_387: db `    add rax, `, 0
    global_string_388: db `\n`, 0
    global_string_389: db `Unsupported type in generate_lvalue_into_rax: `, 0
    global_string_390: db `    push rax\n`, 0
    global_string_391: db `\n`, 0
    global_string_392: db `    call func_`, 0
    global_string_393: db `    add rsp, `, 0
    global_string_394: db `\n`, 0
    global_string_395: db `    mov rax, `, 0
    global_string_396: db `\n`, 0
    global_string_397: db `    mov rax, `, 0
    global_string_398: db `\n`, 0
    global_string_399: db `    mov rax, global_string_`, 0
    global_string_400: db `\n`, 0
    global_string_401: db `Unsupported literal type in generate_expr_into_rax`, 0
    global_string_402: db `    cmp rax, 0\n`, 0
    global_string_403: db `    je .cond_else_`, 0
    global_string_404: db `\n`, 0
    global_string_405: db `    jmp .cond_end_`, 0
    global_string_406: db `\n`, 0
    global_string_407: db `.cond_else_`, 0
    global_string_408: db `:\n`, 0
    global_string_409: db `.cond_end_`, 0
    global_string_410: db `:\n`, 0
    global_string_411: db `    push rax\n`, 0
    global_string_412: db `    pop rbx\n`, 0
    global_string_413: db `    add rax, rbx\n`, 0
    global_string_414: db `    push rax\n`, 0
    global_string_415: db `    pop rbx\n`, 0
    global_string_416: db `    sub rax, rbx\n`, 0
    global_string_417: db `    push rax\n`, 0
    global_string_418: db `    pop rcx\n`, 0
    global_string_419: db `    shl rax, cl\n`, 0
    global_string_420: db `    push rax\n`, 0
    global_string_421: db `    pop rcx\n`, 0
    global_string_422: db `    shr rax, cl\n`, 0
    global_string_423: db `    push rax\n`, 0
    global_string_424: db `    pop rbx\n`, 0
    global_string_425: db `    cqo\n`, 0
    global_string_426: db `    idiv rbx\n`, 0
    global_string_427: db `    push rax\n`, 0
    global_string_428: db `    pop rbx\n`, 0
    global_string_429: db `    cqo\n`, 0
    global_string_430: db `    idiv rbx\n`, 0
    global_string_431: db `    mov rax, rdx\n`, 0
    global_string_432: db `    push rax\n`, 0
    global_string_433: db `    pop rbx\n`, 0
    global_string_434: db `    imul rbx\n`, 0
    global_string_435: db `    push rax\n`, 0
    global_string_436: db `    pop rbx\n`, 0
    global_string_437: db `    cmp rax, rbx\n`, 0
    global_string_438: db `    sete al\n`, 0
    global_string_439: db `    movzx rax, al\n`, 0
    global_string_440: db `    push rax\n`, 0
    global_string_441: db `    pop rbx\n`, 0
    global_string_442: db `    cmp rax, rbx\n`, 0
    global_string_443: db `    setne al\n`, 0
    global_string_444: db `    movzx rax, al\n`, 0
    global_string_445: db `    push rax\n`, 0
    global_string_446: db `    pop rbx\n`, 0
    global_string_447: db `    cmp rax, rbx\n`, 0
    global_string_448: db `    setl al\n`, 0
    global_string_449: db `    movzx rax, al\n`, 0
    global_string_450: db `    push rax\n`, 0
    global_string_451: db `    pop rbx\n`, 0
    global_string_452: db `    cmp rax, rbx\n`, 0
    global_string_453: db `    setle al\n`, 0
    global_string_454: db `    movzx rax, al\n`, 0
    global_string_455: db `    push rax\n`, 0
    global_string_456: db `    pop rbx\n`, 0
    global_string_457: db `    cmp rax, rbx\n`, 0
    global_string_458: db `    setg al\n`, 0
    global_string_459: db `    movzx rax, al\n`, 0
    global_string_460: db `    push rax\n`, 0
    global_string_461: db `    pop rbx\n`, 0
    global_string_462: db `    cmp rax, rbx\n`, 0
    global_string_463: db `    setge al\n`, 0
    global_string_464: db `    movzx rax, al\n`, 0
    global_string_465: db `    push rax\n`, 0
    global_string_466: db `    pop rbx\n`, 0
    global_string_467: db `    and rax, rbx\n`, 0
    global_string_468: db `    push rax\n`, 0
    global_string_469: db `    pop rbx\n`, 0
    global_string_470: db `    or rax, rbx\n`, 0
    global_string_471: db `    push rax\n`, 0
    global_string_472: db `    pop rbx\n`, 0
    global_string_473: db `    xor rax, rbx\n`, 0
    global_string_474: db `    not rax\n`, 0
    global_string_475: db `    neg rax\n`, 0
    global_string_476: db `    cmp rax, 0\n`, 0
    global_string_477: db `    sete al\n`, 0
    global_string_478: db `    movzx rax, al\n`, 0
    global_string_479: db `    cmp rax, 0\n`, 0
    global_string_480: db `    je .or_right_`, 0
    global_string_481: db `\n`, 0
    global_string_482: db `    mov rax, 1\n`, 0
    global_string_483: db `    jmp .or_end_`, 0
    global_string_484: db `\n`, 0
    global_string_485: db `.or_right_`, 0
    global_string_486: db `:\n`, 0
    global_string_487: db `    cmp rax, 0\n`, 0
    global_string_488: db `    setne al\n`, 0
    global_string_489: db `.or_end_`, 0
    global_string_490: db `:\n`, 0
    global_string_491: db `    cmp rax, 0\n`, 0
    global_string_492: db `    jne .and_right_`, 0
    global_string_493: db `\n`, 0
    global_string_494: db `    mov rax, 0\n`, 0
    global_string_495: db `    jmp .and_end_`, 0
    global_string_496: db `\n`, 0
    global_string_497: db `.and_right_`, 0
    global_string_498: db `:\n`, 0
    global_string_499: db `    cmp rax, 0\n`, 0
    global_string_500: db `    setne al\n`, 0
    global_string_501: db `.and_end_`, 0
    global_string_502: db `:\n`, 0
    global_string_503: db `    mov rax, [rax]\n`, 0
    global_string_504: db ` [rax]\n`, 0
    global_string_505: db `    movsx rax, `, 0
    global_string_506: db `    push rax\n`, 0
    global_string_507: db `    pop rbx\n`, 0
    global_string_508: db `\n`, 0
    global_string_509: db `    mov [rbx], `, 0
    global_string_510: db `Unsupported node type in generate_expr_into_rax: `, 0
    global_string_511: db `    xor rax, rax\n`, 0
    global_string_512: db `    push rax\n`, 0
    global_string_513: db `    pop rax\n`, 0
    global_string_514: db `    mov rsp, rbp\n`, 0
    global_string_515: db `    pop rbp\n`, 0
    global_string_516: db `    ret\n`, 0
    global_string_517: db `    mov [rbp-`, 0
    global_string_518: db `], rax\n`, 0
    global_string_519: db `    cmp rax, 0\n`, 0
    global_string_520: db `    je .if_end_`, 0
    global_string_521: db `\n`, 0
    global_string_522: db `.if_end_`, 0
    global_string_523: db `:\n`, 0
    global_string_524: db `    cmp rax, 0\n`, 0
    global_string_525: db `    je .if_else_`, 0
    global_string_526: db `\n`, 0
    global_string_527: db `    jmp .if_end_`, 0
    global_string_528: db `\n`, 0
    global_string_529: db `.if_else_`, 0
    global_string_530: db `:\n`, 0
    global_string_531: db `.if_end_`, 0
    global_string_532: db `:\n`, 0
    global_string_533: db `.loop_start_`, 0
    global_string_534: db `:\n`, 0
    global_string_535: db `.loop_continue_`, 0
    global_string_536: db `:\n`, 0
    global_string_537: db `    cmp rax, 0\n`, 0
    global_string_538: db `    je .loop_end_`, 0
    global_string_539: db `\n`, 0
    global_string_540: db `    jmp .loop_start_`, 0
    global_string_541: db `\n`, 0
    global_string_542: db `.loop_end_`, 0
    global_string_543: db `:\n`, 0
    global_string_544: db `.loop_start_`, 0
    global_string_545: db `:\n`, 0
    global_string_546: db `    cmp rax, 0\n`, 0
    global_string_547: db `    je .loop_end_`, 0
    global_string_548: db `\n`, 0
    global_string_549: db `.loop_continue_`, 0
    global_string_550: db `:\n`, 0
    global_string_551: db `    jmp .loop_start_`, 0
    global_string_552: db `\n`, 0
    global_string_553: db `.loop_end_`, 0
    global_string_554: db `:\n`, 0
    global_string_555: db `\n`, 0
    global_string_556: db `global func_`, 0
    global_string_557: db `:\n`, 0
    global_string_558: db `func_`, 0
    global_string_559: db `    push rbp\n`, 0
    global_string_560: db `    mov rbp, rsp\n`, 0
    global_string_561: db `    sub rsp, `, 0
    global_string_562: db `\n`, 0
    global_string_563: db `    mov rsp, rbp\n`, 0
    global_string_564: db `    pop rbp\n`, 0
    global_string_565: db `    mov qword rax, 0\n`, 0
    global_string_566: db `    ret\n`, 0
    global_string_567: db `Unknown node type in generate_program`, 0
    global_string_568: db `global _main\n`, 0
    global_string_569: db `_main:\n`, 0
    global_string_570: db `    mov rax, rsi\n`, 0
    global_string_571: db `    push rax\n`, 0
    global_string_572: db `    mov rax, rdi\n`, 0
    global_string_573: db `    push rax\n`, 0
    global_string_574: db `global _start\n`, 0
    global_string_575: db `_start:\n`, 0
    global_string_576: db `    mov rbp, rsp\n`, 0
    global_string_577: db `    mov rax, rbp\n`, 0
    global_string_578: db `    add rax, 8\n`, 0
    global_string_579: db `    push rax\n`, 0
    global_string_580: db `    mov rax, [rbp]\n`, 0
    global_string_581: db `    push rax\n`, 0
    global_string_582: db `    mov rbx, global_vars\n`, 0
    global_string_583: db `    add rbx, `, 0
    global_string_584: db `\n`, 0
    global_string_585: db `\n`, 0
    global_string_586: db `    mov [rbx], `, 0
    global_string_587: db `    call func_main\n`, 0
    global_string_588: db `    mov rdi, rax\n`, 0
    global_string_589: db `section .bss\n`, 0
    global_string_590: db `    global_vars: resb `, 0
    global_string_591: db `\n`, 0
    global_string_592: db `section .data\n`, 0
    global_string_593: db `    global_string_`, 0
    global_string_594: db `: db \``, 0
    global_string_595: db `\`, 0\n`, 0
    global_string_596: db `Usage: `, 0
    global_string_597: db ` [options] <file>`, 0
    global_string_598: db `Options:`, 0
    global_string_599: db `  -c <code>  Code to compile`, 0
    global_string_600: db `  -h         Show this help`, 0
    global_string_601: db `  -r         Run the generated executable`, 0
    global_string_602: db `  -o <file>  Output file`, 0
    global_string_603: db `  -d         Dump AST to stdout`, 0
    global_string_604: db `Output file will be named '`, 0
    global_string_605: db `' by default`, 0
    global_string_606: db `-c`, 0
    global_string_607: db `CLI`, 0
    global_string_608: db `-r`, 0
    global_string_609: db `-h`, 0
    global_string_610: db `-d`, 0
    global_string_611: db `-o`, 0
    global_string_612: db `-`, 0
    global_string_613: db `stdin`, 0
    global_string_614: db `Source too long to use through stdin`, 0
    global_string_615: db `.nasm`, 0
    global_string_616: db `.o`, 0
    global_string_617: db `/usr/local/bin/nasm`, 0
    global_string_618: db `/usr/bin/nasm`, 0
    global_string_619: db `-fmacho64`, 0
    global_string_620: db `-felf64`, 0
    global_string_621: db `-o`, 0
    global_string_622: db `/usr/bin/ld`, 0
    global_string_623: db `-o`, 0
    global_string_624: db `-lSystem`, 0
    global_string_625: db `build/output`, 0
